...
# Wybranie tylko ruchu ICMP
train_dataset = train_dataset.loc[train_dataset["protocol_type"] == "icmp"]
test_dataset = test_dataset.loc[test_dataset["protocol_type"] == "icmp"]

# Wybranie zbioru ruchu oznaczonego jako normal
train_dataset = train_dataset.loc[train_dataset["label"] == "normal."]

# Okreslenie istotnych parametrow
features = ["protocol_type","service","flag","zsrc_bytes","srv_count","dst_host_count","dst_host_srv_count","dst_host_same_srv_rate","dst_host_diff_srv_rate","dst_host_same_src_port_rate","label"]
features_no_label = ["protocol_type","service","flag","zsrc_bytes","srv_count","dst_host_count","dst_host_srv_count","dst_host_same_srv_rate","dst_host_diff_srv_rate","dst_host_same_src_port_rate"]
...
# Nauka modelu i weryfikacja danych
model = svm.OneClassSVM(nu=nu, kernel='rbf', gamma=0.1, cache_size=1024)
