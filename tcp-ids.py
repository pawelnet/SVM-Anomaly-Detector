...
# Wybranie tylko ruchu TCP
train_dataset = train_dataset.loc[train_dataset["protocol_type"] == "tcp"]
test_dataset = test_dataset.loc[test_dataset["protocol_type"] == "tcp"]
...
features = ["protocol_type","service","flag","zsrc_bytes","dst_bytes","hot","logged_in","num_compromised","root_shell","num_file_creations","count","same_srv_rate","dst_host_srv_count","dst_host_same_srv_rate","dst_host_same_src_port_rate","dst_host_srv_diff_host_rate","label"]
features_no_label = ["protocol_type","service","flag","zsrc_bytes","dst_bytes","hot","logged_in","num_compromised","root_shell","num_file_creations","count","same_srv_rate","dst_host_srv_count","dst_host_same_srv_rate","dst_host_same_src_port_rate","dst_host_srv_diff_host_rate"]
...
model = svm.OneClassSVM(nu=nu, kernel='rbf', gamma=0.4, cache_size=1024)
